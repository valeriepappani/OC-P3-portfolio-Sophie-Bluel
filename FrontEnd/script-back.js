...
const closeModal2 = document.querySelector('.iconeFermer');
...
let baliseAjoutImg = document.querySelector("#file-upload");
let baliseImgSrc = document.querySelector('#file-preview');
...
form.addEventListener("submit", function (event) {
    ...
    verifierPhoto(baliseAjoutImg)
})

//À l'ajout de l'IMAGE, vérifier si les autres champs sont remplis
baliseAjoutImg.addEventListener("change", function () {
    verifierChamp(baliseTitreImg)
    verifierChamp(baliseOtionCategorie)
    verifierPhoto(baliseAjoutImg)
    ...
    if (baliseImgSrc.src != '' && baliseTitreImg.value != '' && baliseOtionCategorie.value != '') {
        let test = document.querySelector('.message-erreur').style.display="none";
        // test.forEach(tests => {
...
let wrapper2 = document.querySelector('.wrapper-modal-2')
...
//Fermer la modale à l'ajout du projet quand le bouton "valider" est fonctionnel
...
//Test fermeture modale2
// const modalTest= document.querySelector('#modal2');
// const modalAside = document.querySelector('.modal');

// if (modalAside.style.display="flex") {
//     modalTest.addEventListener('click', function () {
//         // modalTest.style.display="none";
//         modalTest.style.display = 'none';
//         modalTest.setAttribute('aria-hidden', 'true');
//         modalTest.setAttribute('aria-modal', 'false');
//         modalTest.removeEventListener('click', closeModal);
//         modalTest.querySelector('.js-modal-close').removeEventListener('click', closeModal)
//         modalTest.querySelector('.js-modal-stop').removeEventListener('click', stopPropagation);
//     })
// }


// const body = document.querySelector('body:not(.wrapper-modal-2');
